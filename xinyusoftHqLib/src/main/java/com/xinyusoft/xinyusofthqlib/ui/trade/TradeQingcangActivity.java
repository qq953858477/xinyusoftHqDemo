 ...
 */
public class TradeQingcangActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xinyusoft_activity_trade_qingcang);
    ...
    private void initView() {
        ...
        fenchenggu = (TextView) findViewById(R.id.xinyusoft_qingcang_fenchenggu);
        TextView  tv_prompt  = (TextView) findViewById(R.id.trade_qingcang_tv_show);
        fenchenggu.setOnClickListener(this);
        listView = (ListView) findViewById(R.id.trade_qingcang_lv);
